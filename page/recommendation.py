...
def display_article_recommendation():
    ...
    # Define enhanced CSS styles for the article card with extended width
    st.markdown("""
        <style>
        .article-card {
            position: relative;
            ...
            overflow: hidden;
            margin: 10px 0;
            height: 420px; /* Adjusted height for image inclusion */
            display: flex;
            ...
            st.markdown(f"""
                <div class="article-card">
                    ...
                    <div class="article-content">
                        ...
                        <div class="cited-count-row">Cited by: {article.get("influential_citation_count", "0")}</div>
                        <div class="article-footer">
                            <a href="https://your-chat-url.com?article_id={article.get("article_id")}" target="_blank" class="ask-me">Ask me</a>
